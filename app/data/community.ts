...
> = {
  ...
  "visitor-reg": { label: "Visitor Pre-Reg", href: "/community/visitor-reg", icon: "V", summary: "Pre-register expected visitors and notify security before they arrive.", searchPlaceholder: "Search visitor registrations…" },
};

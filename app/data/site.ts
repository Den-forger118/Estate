...
/** Ghana cedis — standardized formatter */
...
// Maps a public property slug to the DB project name so detail pages can fetch
// live unit availability for that project without exposing internal project IDs.
export const PROJECT_NAME_BY_SLUG: Record<string, string> = {
  "meadowline-villa":        "Meadowline Estate",
  "cedar-terrace-apartment": "Cedar Terrace Complex",
};

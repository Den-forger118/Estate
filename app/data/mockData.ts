...
export const payments = [
  { ref: "PAY-20260624-001", tenant: "Adrian Sterling", property: "Cedar Terrace, Apt 402", status: "Completed", amount: 4250, date: "2026-06-24", method: "Bank Transfer" },
  { ref: "PAY-20260623-002", tenant: "Global Logistics Ltd", property: "Harbor Plaza, Ground Floor", status: "Pending", amount: 12800, date: "2026-06-23", method: "Cheque" },
  { ref: "PAY-20260622-003", tenant: "Elena Martinez", property: "Heritage Lofts, 12A", status: "Completed", amount: 3100, date: "2026-06-22", method: "Mobile Money" },
  { ref: "PAY-20260620-004", tenant: "Dr. Nana Boateng", property: "Meadowline Villa", status: "Completed", amount: 8500, date: "2026-06-20", method: "Bank Transfer" },
  { ref: "PAY-20260618-005", tenant: "Kwame Asante", property: "Oak Court, 3B", status: "Overdue", amount: 4100, date: "2026-06-18", method: null },
  { ref: "PAY-20260615-006", tenant: "Abena Owusu", property: "Cedar Terrace, Apt 308", status: "Completed", amount: 2950, date: "2026-06-15", method: "Mobile Money" },
];

// ─── MAINTENANCE ──────────────────────────────────────────────────────────

export const maintenanceTickets = [
  { id: "TKT-001", title: "Leak repair in Penthouse B-12", property: "Cedar Terrace", unit: "Penthouse B-12", priority: "Urgent", status: "New" as const, assignee: "Kofi Mensah", createdDate: "2026-06-24", dueDate: "2026-06-24", description: "Tenant reports water ingress from the ceiling of the master bathroom following heavy rains." },
  { id: "TKT-004", title: "Perimeter lighting fault — Gate C", property: "Meadowline Villa", unit: "Perimeter", priority: "Medium", status: "New" as const, assignee: null, createdDate: "2026-06-23", dueDate: "2026-06-25", description: "Three perimeter lights on Gate C sector are non-functional. Security flagged." },
  { id: "TKT-002", title: "Elevator compliance inspection", property: "Cedar Terrace", unit: "Building Common", priority: "Medium", status: "In Progress" as const, assignee: "James Hackman", createdDate: "2026-06-22", dueDate: "2026-06-26", description: "Annual elevator safety certification due. Inspector visit scheduled." },
  { id: "TKT-003", title: "Gym HVAC filter replacement", property: "Oak Court", unit: "Gym", priority: "Low", status: "In Progress" as const, assignee: "Emmanuel Tetteh", createdDate: "2026-06-20", dueDate: "2026-06-30", description: "Quarterly HVAC filter change required for gym air handling units." },
  { id: "TKT-005", title: "Pool pump servicing", property: "Willow Garden", unit: "Pool Area", priority: "Low", status: "Resolved" as const, assignee: "Kofi Mensah", createdDate: "2026-06-10", dueDate: "2026-06-15", description: "Routine annual pool pump service and chemical balance check." },
  { id: "TKT-006", title: "Intercom system reset — Block A", property: "Cedar Terrace", unit: "Block A", priority: "Medium", status: "Resolved" as const, assignee: "James Hackman", createdDate: "2026-06-08", dueDate: "2026-06-10", description: "Intercom panel in Block A lobby required firmware reset after power fluctuation." },
];

// ─── MESSAGES ─────────────────────────────────────────────────────────────

export const messages = [
  { id: "MSG-001", sender: "Dr. Nana Boateng", avatar: "NB", unit: "Meadowline Villa", subject: "Regarding the perimeter lighting", preview: "Good morning, I wanted to follow up on the reported fault at Gate C...", time: "09:14", date: "2026-06-24", unread: true, body: "Good morning, I wanted to follow up on the reported fault at Gate C. My security team noticed the lights were still off last night. Could you give me an update on the repair timeline? Thank you." },
  { id: "MSG-002", sender: "Abena Owusu", avatar: "AO", unit: "Cedar Terrace, Apt 308", subject: "Move-out checklist request", preview: "Hello, as I am vacating at end of November, please could you send...", time: "08:30", date: "2026-06-24", unread: true, body: "Hello, as I am vacating at end of November, please could you send me the official move-out checklist and schedule a final inspection? I want to ensure the deposit is fully returned." },
  { id: "MSG-003", sender: "Kwame Asante", avatar: "KA", unit: "Oak Court, 3B", subject: "Payment arrangement request", preview: "I apologise for the delay on this month's rent. I would like to...", time: "Yesterday", date: "2026-06-23", unread: false, body: "I apologise for the delay on this month's rent. I would like to request a short payment arrangement — I can settle the full outstanding by the 31st. Please advise if this is acceptable." },
  { id: "MSG-004", sender: "Estate Security", avatar: "ES", unit: "Operations", subject: "Nightly patrol report — 23 Jun", preview: "All sectors completed. No irregularities. Gate A manual override tested...", time: "Yesterday", date: "2026-06-23", unread: false, body: "All sectors completed. No irregularities. Gate A manual override tested and confirmed operational. Gate C lights still awaiting maintenance — logged as TKT-004." },
  { id: "MSG-005", sender: "Elena Martinez", avatar: "EM", unit: "Heritage Lofts, 12A", subject: "Lease renewal enquiry", preview: "My lease expires December 31st. I would love to renew for another year...", time: "Mon", date: "2026-06-22", unread: false, body: "My lease expires December 31st. I would love to renew for another year if terms remain similar. Could you send me the renewal proposal at your earliest convenience?" },
];

// ─── COMMUNITY ────────────────────────────────────────────────────────────

export const events = [
  { id: "EVT-001", title: "Wine & Jazz Soirée", date: "2026-07-28", time: "7:00 PM", location: "Estate Lounge, Ground Floor", category: "Social", capacity: 40, rsvp: 27, description: "Join fellow residents for an evening of vintage jazz performed by the Accra String Quartet and a sommelier-curated wine selection.", image: estateImages.networking, when: "Fri 7:00 PM", tag: "Community Exclusive" },
  { id: "EVT-002", title: "Roof Garden Yoga", date: "2026-07-02", time: "8:00 AM", location: "Terrace West", category: "Wellness", capacity: 20, rsvp: 12, description: "A guided sunrise yoga session on the west terrace. Mats provided. All levels welcome.", image: estateImages.communityGathering, when: "Sat 8:00 AM", tag: "Wellness" },
  { id: "EVT-003", title: "Art Gallery Opening", date: "2026-07-05", time: "6:00 PM", location: "Main Lobby Gallery", category: "Culture", capacity: 60, rsvp: 38, description: "The opening of Kwabena Acheampong's residency exhibition \"Between Borders\" — a collection of large-format photography.", image: estateImages.briefing, when: "Tue 6:00 PM", tag: "Culture" },
  { id: "EVT-004", title: "Estate AGM", date: "2026-07-15", time: "10:00 AM", location: "Conference Room B", category: "Official", capacity: 80, rsvp: 54, description: "Annual General Meeting covering estate budget review, service charge update, and resident committee elections.", image: estateImages.communityLobby, when: "Fri 10:00 AM", tag: "Committee" },
];
...
export const securityNotices = [
  { id: "SEC-001", type: "Alert", title: "Main Gate Maintenance", text: "Maintenance on the automatic recognition system between 22:00 and 02:00 tonight. Please use manual entry.", status: "Active", log: "4928", date: "2026-06-24", posted: "Posted 2h ago" },
  { id: "SEC-002", type: "Notice", title: "Pool Deck Reservation", text: "The north pool deck will be reserved for a private corporate event this Thursday from 14:00 to 18:00.", status: "Scheduled", log: "4912", date: "2026-06-23", posted: "Posted yesterday" },
];
...
export const facilityBookings = [
  { id: "BKG-001", facility: "Rooftop Terrace", resident: "Alex Morgan", date: "2026-07-26", startTime: "10:00", endTime: "12:00", status: "Confirmed" },
  { id: "BKG-002", facility: "Conference Room B", resident: "Dr. Nana Boateng", date: "2026-07-28", startTime: "09:00", endTime: "11:00", status: "Confirmed" },
  { id: "BKG-003", facility: "BBQ Area", resident: "Adrian Sterling", date: "2026-07-27", startTime: "16:00", endTime: "20:00", status: "Pending" },
];
...
export const documents = [
  { id: "DOC-001", folder: "Lease Agreements", fileCount: 14, lastUpdated: "2026-06-20", icon: "L" },
  { id: "DOC-002", folder: "Inspection Reports", fileCount: 8, lastUpdated: "2026-06-15", icon: "I" },
  { id: "DOC-003", folder: "Financial Statements", fileCount: 6, lastUpdated: "2026-06-01", icon: "F" },
  { id: "DOC-004", folder: "Compliance Certificates", fileCount: 11, lastUpdated: "2026-05-28", icon: "C" },
];
...
export const securityAnnouncements = [
  ...
  { title: "Scheduled gate maintenance", body: "South entrance biometric scanner calibration Friday 01:00–03:00.", date: "2026-06-21", tag: "Update" },
];

...
export const blogPosts = [
  ...
  },
  {
    ...
    date: "2026-05-28",
    excerpt:
      "From pre-registering a visitor for a delivery driver in thirty seconds flat to filing an instant hazard report on a cracked pavement — here is what daily estate life feels like when the technology actually works.",
    readTime: "5 min read",
    ...
    content: [
      ...
      "Instead, you open the Resident OS on your phone, navigate to Visitor Pre-Registration, and fill in a form that takes thirty seconds: your plumber's full name, his phone number, his expected arrival window, the purpose of the visit, and — since he is driving — his vehicle registration plate. You tap Register Visitor. A confirmation appears: your plumber is now on the estate's expected visitor list for that morning. Done.",
      "At the perimeter, your plumber arrives and gives his name to the gate guard. The guard opens the Visitor Log on the staff dashboard and finds his name immediately — listed under today's expected visitors with his arrival time, purpose, and vehicle plate all pre-loaded. The guard taps Check In. The barrier lifts within seconds. No queues. No paper logbooks. No phone calls trying to reach the resident. The entire access event is timestamped and logged, visible to management at any time.",

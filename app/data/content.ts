...
export const testimonials = [
  {
    quote: "The transition to our new estate was seamless. Special Gardens represents a standard of management we had not found elsewhere in the region.",
    name: "Mr. Kwame Adu",
  ...
  {
    quote: "Quiet luxury is not just a tagline here — it is a daily experience. Every detail from landscaping to security is handled with supreme discretion.",
    name: "Elena Ross",
    role: "Senior Partner",
  ...
  {
    quote: "Management that understands the value of time and privacy. The institutional excellence here is palpable in every interaction.",
    name: "Dr. Samuel Osei",
